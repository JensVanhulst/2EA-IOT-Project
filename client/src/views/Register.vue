                      ...
                      <v-container fluid>
                        <v-row justify="center">
                          <v-col cols="10" class="pa-0 ma-1">
                            <v-text-field label="Naam" v-model="signUpName" :rules="[rules.required]" :counter="20" outlined></v-text-field>
                          </v-col>

                          <v-col cols="10" class="pa-0 ma-1">
                            <v-text-field label="Email" v-model="signUpEmail" :rules="[rules.required, rules.email]" outlined></v-text-field>
                          </v-col>
                          ...
                          <v-col cols="10" class="pa-0 ma-1 text-center">
                            <v-btn v-on:click="register" outlined rounded> Registreer nu !</v-btn>
                          </v-col>
                        </v-row>
                      </v-container>
                    </v-form>
