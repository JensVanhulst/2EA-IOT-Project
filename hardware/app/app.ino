...
IPAddress server(192 , 168, 1, 119);
//char server[] = "jensv.test";  // also change the Host line in httpRequest()
...
//5min = 300000
//15min = 900000
unsigned long intervalLightSensor = 300;
unsigned long intervalTempSensor = 900;
...
int getTemperature(void) {
  int chk = DHT.read11(tempSensor.sensorPin);
